...
- Generated Data: Based on each instance, we apply 7 different mutations (2 syntax and 5 semantics) to the gold sentence and the results are saved in `data/generated_data/`.
